        ...
        <vue-modal v-model="toggle" title="Add new book">
            <ValidationObserver v-slot="{ invalid }" ref="form">
                <div class="form">
                    ...
                    <ValidationProvider name="Author" rules="required" v-slot="{ errors, classes }">
                        <div class="input-group">
                    ...
                    <ValidationProvider name="Cost" rules="required|numeric" v-slot="{ errors, classes }">
                        <div class="input-group">
                    ...
                    <ValidationProvider name="Sale" rules="numeric|max_value:100" v-slot="{ errors, classes }">
                        <div class="input-group">
                        ...
                        <div class="right">
                            ...
                            >
                                ...
                                <v-date-picker v-model="publishingdate" no-title scrollable>
                                    ...
                                    <v-btn text color="primary" @click="$refs.menu.save(publishingdate)"> OK </v-btn>
                                </v-date-picker>
                            </v-menu>
                        </div>
                    </div>
                ...
                <button @click="handleAddBook" :disabled="invalid" class="btn btn-primary">Add</button>
            </ValidationObserver>
        </vue-modal>
    </div>
</template>
